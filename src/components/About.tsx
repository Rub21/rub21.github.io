        ...
        <div className='grid grid-cols-6 auto-rows-auto'>
            ...
            <div className='row-span-2 col-start-1 col-end-5 text-base text-textDark font-medium max-mdl:col-span-full'>
                ...
                <div className='mdl:w-11/12 text-xs sm:text-sm sml:text-base'>
                    ...
                    <p>
                    As a dedicated programmer with international experience, I specialize in developing tools and pipelines for managing large volumes of vector data, specifically
           for machine learning and cartography applications.
           
            My areas of expertise encompass geodata analysis, geodata visualization, DevOps, 
          and full-stack development.
           I'm an enthusiastic advocate of open-source technologies and open data, which are my go-to resources for application development.
           <br /> <br />

           

           I am an active member of the OpenStreetMap community, known there as Rub21.
