  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-base font-light flex gap-2 text-textDark">
        <strong>
          I have experience working as a Full Stack Developer at Mashauri
          Limited, an entrepreneurial school providing B2B and B2C services,
          including courses and materials for students. In this role, I played a
          crucial part in various areas:
        </strong>
      </p>
