  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-base font-light flex gap-2 text-textDark">
        <strong>
          Played a pivotal role in ensuring the quality and robustness of a
          widely utilized AI virtual assistant, integral to daily operations
          worldwide, through comprehensive testing methodologies
        </strong>
      </p>
