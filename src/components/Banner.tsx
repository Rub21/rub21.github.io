...
const Banner = () => {
  ...
  return (
    ...
    >
      ...
      >
        {" "}
        I am a Full-Stack developer specializing in geographic information systems and machine learning-based data processing. I was drawn to programming
         by a passion for automation—it's magical to see how code can simplify life. I have an insatiable appetite for continued learning in this ever-evolving field.
        <br /><br />
