  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-base font-light flex gap-2 text-textDark">
        <strong>
          By utilizing technical skills in SQL database management, Python
          scripting, and content management with WordPress, I actively supported
          the growth and success of the art auction start-up. Collaborating
          closely with the team, I ensured seamless data migration, enhanced
          website content, and facilitated efficient product management.{" "}
        </strong>
      </p>
