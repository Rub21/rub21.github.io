  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-1 font-medium text-xl font-titleFont flex-col sml:flex-row">
        <h3>Data Team Lead and Data Engineer</h3>
      </div>

      {/* Working Dates */}
      <p className="pt-3">June 2012 - December 2018</p>

      {/* INTRODUCTION */}
      <p className="mt-3 text-base font-light flex gap-2 text-textDark">
        <strong>
          Promoted to a taem lead position, along with and ontop of my QA/QE
          responsibilities. My role involved actively supporting managers and
          overseeing the operations of multiple teams.
          <br />
